...
export default function AddNewGroupDialog() {
  ...
  const [resource] = useState("/groups");
  ...
  const render_data = data => {
    ...
    return (
      <>
        <Button group="secondary" onClick={handleClickOpen}>
          <AddIcon />
          Add New Group
        </Button>
        <Dialog
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>Group name must be unique.</DialogContentText>
            <TextField
              autoFocus
              margin="dense"
              value={group}
              ...
              helperText={is_error ? "Group name must be unique." : ""}
            />

            <Box mt={2}>{groups}</Box>
          </DialogContent>
          <DialogActions>
            <Button onClick={handleClose} group="primary">
              Cancel
            </Button>
            <Button
              variant="contained"
